...
func main() {
	...
	if home := homedir.HomeDir(); home != "" {
		a = filepath.Join(home, ".kube", "config")
		b = "(optional) absolute path to the kubeconfig file"
	} else {
		a = ""
		b = "absolute path to the kubeconfig file"
	}
	kubeconfig = flag.String("konfig", a, b)
